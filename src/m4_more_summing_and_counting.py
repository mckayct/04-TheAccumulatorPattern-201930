...
def run_test_count_cosines_from():
  ...
  # Test 2:
    expected = 0
    answer = count_cosines_from(3, 5, .7)
    ...
    # Test 4:
    expected = 1
    answer = count_cosines_from(5, 6, 0.3)
    ...
    # Test 6:
    expected = 1
    answer = count_cosines_from(4, 5, -.5)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.36666  # This is APPROXIMATELY the correct answer.
